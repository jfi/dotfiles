...
- For all gems I create unless I say otherwise: author to "Otaina Limited",
  "James Inman" and the email to "<james@otaina.co.uk>" for all gems please.
- All the core docs that are front-facing (i.e. for system users rather than
  developers) can go in cms/docs
- When generating lists in Markdown files, add proper blank lines above/below
  them so they'll pass markdownlint.
